...
const buttonVariants = cva(
  "flex items-center justify-center rounded-md font-medium text-white duration-300 dark:text-black disabled:bg-indigo-400 disabled:hover:cursor-not-allowed",
  {
    variants: {
      variant: {
        // ** FILLED
  ...
  return (
    ...
    >
      <div className="flex items-center">
        {isLoading?<svg
          aria-hidden="true"
          className="w-5 h-5 text-gray-200 mr-3 animate-spin dark:text-gray-400 fill-white"
          viewBox="0 0 100 101"
          fill="none"
